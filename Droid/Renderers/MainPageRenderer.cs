...
using Hello;
using Hello.Droid.Renderers;
// using hello.Views;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android;
using Color = Android.Graphics.Color;

[assembly: ExportRenderer(typeof(TabsPage), typeof(MainPageRenderer))]

namespace Hello.Droid.Renderers
{
    internal class MainPageRenderer : VisualElementRenderer<TabsPage>, IOnTabClickListener
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<TabsPage> e)
        {
        ...
        private void InitializeElement(TabsPage element)
        {
            PopulateChildren(element);
        }

        private void PopulateChildren(TabsPage element)
        {
        ...
        private void ClearElement(TabsPage element)
        {
            if (_currentPage != null)
            {
